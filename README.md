About wikipedia-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/wikipedia-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/goldsmith/Wikipedia
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5865&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/wikipedia-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `wikipedia` can be installed with `conda`:
...
It is possible to list all of the versions of `wikipedia` available on your platform with `conda`:
...
```
mamba search wikipedia --channel conda-forge
```
...
mamba repoquery search wikipedia --channel conda-forge

# List packages depending on `wikipedia`:
mamba repoquery whoneeds wikipedia --channel conda-forge

# List dependencies of `wikipedia`:
mamba repoquery depends wikipedia --channel conda-forge
```
